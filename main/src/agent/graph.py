...
def create_supervisor_system():
    ...
    # DOCX Agent for document manipulation (already imported as docx_agent_graph)
    ...
    supervisor_prompt = (
        ...
        "- docx_agent: Handles DOCX document operations (read, search, edit, create Word documents).\n"
        "- general_assistant: Answers questions using the RAG database.\n\n"
        ...
        "- If user asks to 'edit docx', 'create docx', 'read word document', 'modify document', or mentions 'docx' or 'word document', respond EXACTLY with: 'I will route this to docx_agent'.\n"

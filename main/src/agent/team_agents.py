...
Phases & Costs:
- Phase 1: Consultation & Assessment — $5,000 (needs assessment, project scope).
- Phase 2: Implementation — $20,000 (deployment, software install & config).
- Phase 3: Training & Support — $10,000 (user training, 6-month support).
...
"""
            ...
            # Add completion message
            messages = state.get("messages", [])
            # append "/Users/yash/Documents/rfp/rfp-bid/main/static/images/Screenshot 2025-09-14 at 12.29.56 PM.png" image to the message in md format
